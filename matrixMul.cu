...
void runTest(int argc, char** argv){
    ...
    // Print demension of A and B
    printf("HA=%d, WA=%d, HB=%d, WB=%d\n\n", HA, WA, HB, WB);
    // By default,
    // BLOCK_SIZE = 16
    // HA = 16 * BLOCK_SIZE = 256
    // WA = 32 * BLOCK_SIZE = 512
    // HB = WA = 512
    // WB = 24 * BLOCK_SIZE = 384
    ...
    computeGold(reference, h_A, h_B, HA, WA, WB);	// in matrixMul_glod.cpp
